...
{
    //Doc.
    //docs.spatie.be/laravel-permission/v3/introduction
    ...
    {
        $this->validate($request, ['name' => 'required|unique:roles,name', 'permission' => 'required']); //validar (único e roles e name) ( e permission que vem da view e é obrigatório)
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $id) //recebe dados do formulário, validar e atualizar banco
    {
        ...
        $role->syncPermissions($request->input('permission')); //atualiza a permissão de determinado perfil
