...
Route::post('login', [App\Http\Controllers\APIController::class, 'login']); //colocar isso /chama a classe
Route::get('logout', [App\Http\Controllers\APIController::class, 'logout']);

Route::group(['middleware' => 'auth.jwt', 'prefix' => 'v1'], static function () { //prefixo para todos os 'end points'.
...
Route::group(['middleware' => 'auth.jwt', 'prefix' => 'v2'], static function () { //prefixo para todos os 'end points'.
